...
def run(args_list=None):
    ...
    parser.add_argument("--val_dataset_path", type=str, default="./datasets/mapper_training_dataset/DoD_2_5k_Mistral/val_mapper_dataset.pt")
    parser.add_argument("--lora_dir", type=str, default="./mapper_lora_weights/DoD_2_5k_Mistral")
    parser.add_argument("--training_stats_path", type=str, default="./trained_soft_prompts/DoD_2_5k_Mistral/accuracy_stats.csv")
